...
def bbox_iou(box1, box2, giou=False, diou=False, ciou=False, mdpiou=False,eps=1e-9):
    ...
    Args:
        ...
        mdpiou(bool): whether use mdpiou or not, default False
...
#此部分代码是为了使用一个yolov8比较先进的IOU损失计算函数 而做的修改但无法获取特征图的一个宽和高 因为它里面使用的是一个quary
'''
elif mdpiou:
    d1=(px1-gx1)**2+(py1-gy1)**2
    d2=(px2-gx2)**2+(py2-gy2)**2
