...
__all__ = ['HybridEncoder1']


class CSPRepLayer1(nn.Layer):
    def __init__(self,
                 in_channels,
                 out_channels,
                 num_blocks=3,
                 ...
                 bias=False,
                 act="silu"):
        super(CSPRepLayer1, self).__init__()
...
@register
class TransformerLayer1(nn.Layer):
    def __init__(self,
                 d_model,
                 nhead,
...
class HybridEncoder1(nn.Layer):
    ...
    def __init__(self,
                 ...
                 trt=False,
                 eval_size=None):
        super(HybridEncoder1, self).__init__()
