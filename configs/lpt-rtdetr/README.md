...
python tools/train.py -c configs/lpt-LPT/LPT_pooling_6x_coco.yml --eval
```
...
python -m paddle.distributed.launch --gpus 0,1,2,3 tools/train.py -c configs/lpt-LPT/LPT_pooling_6x_coco.yml --fleet --eval
```

- 评估:

```shell
python tools/eval.py -c configs/lpt-LPT/LPT_pooling_6x_coco.yml \
...
```shell
python tools/infer.py -c configs/lpt-LPT/LPT_pooling_6x_coco.yml \
              -o weights=https://bj.bcebos.com/v1/paddledet/models/rtdetr_r50vd_6x_coco.pdparams \
...
```shell
cd PaddleDetection
python tools/export_model.py -c configs/lpt-LPT/LPT_pooling_6x_coco.yml \
