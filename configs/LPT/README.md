...
| RT-DETR-R50 | 6x |  ResNet-50 | 640 | 53.1 | 71.3 | 42 | 136 | 108 | [download](https://bj.bcebos.com/v1/paddledet/models/rtdetr_r50vd_6x_coco.pdparams) | [config](./LPT_pooling_6x_coco.yml)
...
python tools/train.py -c configs/LPT/LPT_pooling_6x_coco.yml --eval
```
...
python -m paddle.distributed.launch --gpus 0,1,2,3 tools/train.py -c configs/LPT/LPT_pooling_6x_coco.yml --fleet --eval
```

- 评估:

```shell
python tools/eval.py -c configs/LPT/LPT_pooling_6x_coco.yml \
...
```shell
python tools/infer.py -c configs/LPT/LPT_pooling_6x_coco.yml \
              -o weights=https://bj.bcebos.com/v1/paddledet/models/rtdetr_r50vd_6x_coco.pdparams \
...
```shell
cd PaddleDetection
python tools/export_model.py -c configs/LPT/LPT_pooling_6x_coco.yml \
