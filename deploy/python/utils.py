...
def argsparser():
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default='D:\py12\\aim\PaddleDetection-develop\\123\\tools\output_inference\rtdetr_r50vd_6x_coco',
    ...
    parser.add_argument(
        "--video_file",
        type=str,
        default='D:\py12\pingtai\LPT\demo\demo1.mp4',
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="D:\py12\pingtai\detection_video",
