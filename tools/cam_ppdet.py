...
def parse_args():
    ...
    parser.add_argument(
        "--infer_img",
        type=str,
        default='D:\py12\\aim\\PaddleDetection-develop\\demo\\000000014439.jpg',    # hxw: 404x640
        help="Image path, has higher priority over --infer_dir")
    parser.add_argument("--weights",
                        type=str,
                        default='D:\py12\\aim\PaddleDetection-develop\\tools\output_inference\\rtdetr_r50vd_6x_coco\\model.pdiparams'
                        )
...
def run(FLAGS, cfg):
    assert cfg.architecture in ['FasterRCNN', 'MaskRCNN', 'YOLOv3', 'PPYOLOE',
                                'PPYOLOEWithAuxHead', 'BlazeFace', 'SSD', 'RetinaNet','DETR'],  \
